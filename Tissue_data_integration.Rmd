...
dir.intestine <- "path-to-intestine-directory"  
dir.stomach <- "path-to-stomach-directory" 

## get all DEA data
DEA_SI <- readRDS( paste(dir.intestine,"RData/DEA_all.RData", sep ="/")) # derive from "Tissue_specific_RNA-Seq_Analysis.Rmd"
DEA_ST <- readRDS( paste(dir.stomach,"RData/DEA_all.RData", sep ="/")) # derive from "Tissue_specific_RNA-Seq_Analysis.Rmd"
...
## get curated/manually annotated data
DEA_SI <- read_xlsx( paste(dir.intestine,"processed data/DEA_lfc_3_Thomas_manual_SI.xlsx", sep ="/"))
DEA_ST <- read_xlsx( paste(dir.stomach,"processed data/DEA_lfc_3_Thomas_manual_Stomach.xlsx", sep ="/"))
